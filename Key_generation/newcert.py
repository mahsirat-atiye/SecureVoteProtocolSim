...
def generatecsr():
    ...
    if option == 1:
        ...
        c = ('Enter your country(ex. US): ')
        st = ("Enter your state(ex. Nevada): ")
        l = ("Enter your location(City): ")
        o = ("Enter your organization: ")
        ou = ("Enter your organizational unit(ex. IT): ")
    else:
    ...
    reply = str(('Is this a Self-Signed Cert (y/n): ')).lower().strip()
